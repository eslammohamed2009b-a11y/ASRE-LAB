...
_CONTRACT_DETAILS: dict[str, dict] = {
    ...
    "thermal_conduction_v1": {"numerical_method": "1D: finite-difference assembled linear system with direct numpy.linalg.solve. 3D: Gauss-Seidel-style iterative finite-difference solve.", "discretization": "1D uniform 2-500-node rod/slab; 3D uniform cubic 5-40-node grid with a 7-point stencil.", "supported_geometry": ["uniform_1d_rod_or_slab", "uniform_cubic_3d_domain"], "consumes_cad_geometry": False, "geometry_dependency_description": "Uses requested scalar dimensions and uniform-grid settings only; does not consume design artifacts or CAD meshes.", "validity_envelope": {"1d_nodes": "2 to 500", "3d_nodes_per_edge": "5 to 40", "geometry": "uniform rod/slab or cube only"}, "convergence_requirements": "1D is a direct solve. For 3D, the Gauss-Seidel residual must meet the requested tolerance; use grid refinement where discretization error matters.", "implementation_reference": "app.module2_simulation.solvers.thermal_solver.ThermalConductionSolver"},
