...
SOLVER_REGISTRY.update({
    ...
    "acoustic_helmholtz_fem_3d_v1": CapabilityEntry(
        ...
        output_metrics=["complex nodal pressure", "pressure amplitude", "pressure phase", "SPL", "algebraic residual", "k*h_max"],
        validity_envelope={"nodes": "<= 5000", "elements": "<= 20000", "dispersion": "k*h_max <= 0.5", "residual": "<= 1e-8"},
        convergence_requirements="Finite complex field, normalized free-DOF algebraic residual <= 1e-8, and k*h_max <= 0.5 are required.",
        ...
        benchmark_references=["tests/integration/test_acoustic_fem_3d.py::test_real_acoustic_3d_plane_wave_accuracy"],
    ),
})
